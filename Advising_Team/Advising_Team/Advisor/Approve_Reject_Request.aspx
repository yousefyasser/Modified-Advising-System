<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approve_Reject_Request.aspx.cs" Inherits="Advising_Team.Advisor.Approve_Reject_Request" %>
    ...
    <form id="form2" runat="server">
        <div>
            ...
            <a href="Approve_Reject_Credit_Hour_Request.aspx" class="option-btn">Credit Hour</a>
                        <asp:HyperLink ID="view_reqs" href="View_All_Requests.aspx" runat="server">View Requests</asp:HyperLink>
                            <br />
                        <br />
