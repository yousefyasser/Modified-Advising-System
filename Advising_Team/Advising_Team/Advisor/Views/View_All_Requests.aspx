<%@ Page Title="View All Requests" Language="C#" MasterPageFile="Site1.Master" AutoEventWireup="true" CodeBehind="View_All_Requests.aspx.cs" Inherits="Advising_Team.Advisor.Views.View_All_Requests" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <div class="custom-table-container">
        ...
        <asp:HyperLink ID="view_appRej_Req" href="../Requests/Approve_Reject_Request.aspx" runat="server">Approve/Reject</asp:HyperLink>
      <br />
      <br />
